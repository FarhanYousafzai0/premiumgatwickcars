  ...
  return (
    <>
      ...
      >
        ...
        {/* Left: Text */}
        <div className="flex flex-col justify-center items-start gap-4 sm:gap-6 lg:gap-8 z-10 pr-0 lg:pr-8">
        ...
        {/* Right: Booking Form */}
        <div className="z-10 flex items-center justify-center mt-8 lg:mt-0">
          <div className="w-full max-w-md lg:max-w-lg xl:max-w-xl">
            ...
            <div className="text-center mb-4">
              <h2 className="text-xl sm:text-2xl font-bold text-white mb-2">Book Your Ride</h2>
              <div className="flex justify-center items-center space-x-2 sm:space-x-4">
                <div className={`flex items-center text-xs sm:text-sm ${currentStep >= 1 ? 'text-white' : 'text-gray-300'}`}>
                  <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs ${currentStep >= 1 ? 'bg-white text-black' : 'bg-gray-400'}`}>1</div>
                  <span className="ml-1 sm:ml-2 font-medium hidden sm:inline">Journey</span>
                </div>
                <div className="w-8 sm:w-12 h-px bg-gray-300"></div>
                <div className={`flex items-center text-xs sm:text-sm ${currentStep >= 2 ? 'text-white' : 'text-gray-300'}`}>
                  <div className={`w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center text-xs ${currentStep >= 2 ? 'bg-white text-black' : 'bg-gray-400'}`}>2</div>
                  <span className="ml-1 sm:ml-2 font-medium hidden sm:inline">Details</span>
                </div>
              </div>
            </div>
