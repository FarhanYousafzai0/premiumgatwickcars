...
// util: detect scroll direction (down = hide, up = show)
...
export default function HeaderNav() {
  ...
  const dir = useScrollDirection({ threshold: 6 });
  ...
  return (
    <>
      ...
      <motion.header
        initial={false}
        animate={{ y: dir === "down" ? -80 : 0 }}
        transition={{ duration: 0.28, ease: [0.22, 1, 0.36, 1] }}
        className="fixed top-2  left-0 right-0 z-50 bg-white/95 backdrop-blur border-b border-gray-200"
      >
        <div className="max-w-6xl mx-auto flex items-center rounded-md  justify-between py-3 px-4">
          {/* Logo */}
          <Link
  to="/"
            ...
            >
              ...
              <div className="px-3 py-3">
                ...
                <div className="mt-2 px-3">
                  <GlassButton as="a" href="#booking" className="w-full">
